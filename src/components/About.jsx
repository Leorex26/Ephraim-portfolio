...
import AboutImage from '../assets/mypics.jpg'
            ...
            <div className='flex-1'>
                ...
                <div className='space-y-4'>
                    ...
                    <div className='flex items-center'>
                        ...
                        <div className='grow bg-gray-800 rounded-full h-2.5'>
                            <div className='bg-gradient-to-r from-green-400 to-blue-500 h-2.5 
                            rounded-fulltransform transition-transform duration-300 hover:scale-105 w-11/12'>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center'>
                        ...
                        <div className='grow bg-gray-800 rounded-full h-2.5'>
                            <div className='bg-gradient-to-r from-green-400 to-blue-500 h-2.5 
                            rounded-fulltransform transition-transform duration-300 hover:scale-105 w-9/12'>
                            </div>
                        </div>
                    </div>
                </div>
